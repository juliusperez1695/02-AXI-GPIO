...
HD_PWD='C:/Xilinx/ECE520/02-AXI_GPIO/axi_gpio_ext_jp/axi_gpio_ext_jp.runs/axi_gpio_ext_jp_axi_gpio_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio_ext_jp_axi_gpio_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_gpio_ext_jp_axi_gpio_2_0.tcl
