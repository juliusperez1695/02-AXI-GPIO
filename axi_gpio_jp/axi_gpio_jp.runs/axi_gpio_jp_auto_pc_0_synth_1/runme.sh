...
HD_PWD='C:/Xilinx/ECE520/02-AXI_GPIO/axi_gpio_jp/axi_gpio_jp.runs/axi_gpio_jp_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio_jp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_gpio_jp_auto_pc_0.tcl
