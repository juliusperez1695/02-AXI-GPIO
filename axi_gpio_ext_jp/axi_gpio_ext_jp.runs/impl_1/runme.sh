...
HD_PWD='C:/Xilinx/ECE520/02-AXI_GPIO/axi_gpio_ext_jp/axi_gpio_ext_jp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_gpio_ext_jp_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source axi_gpio_ext_jp_wrapper.tcl -notrace
